...
import { LS_ONBOARDED } from '../../config/constants'
import { CpuIcon, SparklesIcon, GlobeIcon } from '../ui/icons'
...
export default function OnboardingOverlay({ onDone = () => { } }) {
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div className="onboarding__card relative rounded-2xl max-w-sm w-full mx-4 p-8 text-center animate-fade-in gradient-border">

        {/* Inner glow */}
        <div className="onboarding__card-glow" aria-hidden="true" />

        {/* Hero icon */}
        <div
          className="onboarding__hero-icon inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-5 animate-float"
          aria-hidden="true"
        >
          <SparklesIcon className="w-9 h-9 text-purple-400" />
        </div>
