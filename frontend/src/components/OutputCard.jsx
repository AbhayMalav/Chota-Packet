...
import { SparklesIcon, ChevronDownIcon, ClipboardIcon, CheckIcon, SendIcon, TrashIcon, ClaudeIcon, PerplexityIcon, GrokIcon, DeepSeekIcon, MistralIcon, SarvamIcon, AIFiestaIcon } from './icons'
import '../styles/components/OutputCard.css'
