...
export function PaletteIcon({ className = 'w-4 h-4' }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} {...iconA11y}>
      <path fillRule="evenodd" d="M11.986 3a8.986 8.986 0 0 0-8.986 8.986c0 4.965 4.021 8.986 8.986 8.986 1.674 0 3.109-.944 3.864-2.315.112-.2.012-.444-.199-.54l-.452-.204a2.535 2.535 0 0 1-1.39-2.348v-.048c0-.795.646-1.44 1.441-1.44h.99c2.378 0 4.305-1.927 4.305-4.305v-.867C20.545 5.517 16.713 3 11.986 3ZM7 9a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm4.5-2.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm4.5 2.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM17 14a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z" clipRule="evenodd"/>
    </svg>
  )
}
